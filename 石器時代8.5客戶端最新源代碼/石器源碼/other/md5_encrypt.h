// Md5A.h: interface for the CMd5 class.
//
//////////////////////////////////////////////////////////////////////
...
void MD5Init (MD5_CTX_ENCRYPT *context);
void MD5Update(MD5_CTX_ENCRYPT *context, unsigned char *input,unsigned int inputLen);
void MD5Final (unsigned char digest[16], MD5_CTX_ENCRYPT *context);
