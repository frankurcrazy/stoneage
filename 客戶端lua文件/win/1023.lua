...
function ServerWindowType()
	...
	str = string.format("“寵物名字”          “騎乘許可”          “寵物造型”");
	...
	for i =lstart,lend do
		...
		sa.StockFontBuffer(winX*2+125-sa.getTextLength(RideData["寵物名"][i])/2,winY*2+44+index*24, 1, 5, RideData["寵物名"][i], 0);
		sa.StockFontBuffer(winX*2+250,winY*2+44+index*24, 1, 5, RideData["許可"][i], 0);
