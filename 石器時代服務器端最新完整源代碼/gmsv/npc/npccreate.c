...
int NPC_readCreateFile( char* filename )
{
    ...
    int     defborn=FALSE;              /*  born 毛澀爛仄凶井升丹井 */
    int     defmove=FALSE;              /*  move 毛澀爛仄凶井升丹井 */
    
#ifdef _NPC_AUTO_MOVE	    
		POINT   automove[2]={{0,0},{0,0}};
#endif
    int     deflurd[2]={FALSE,FALSE};   /*  lu,rd 匹澀爛仄凶井升丹井 */
    char*   ret;
...
BOOL NPC_readNPCCreateFiles( char* topdirectory ,int createsize)
{
    ...
    print( "正確創建NPC %d ..." , NPC_create_readindex );
