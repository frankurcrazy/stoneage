...
#define PETRACEDROPSTAKETIME						120	// 2分鍾 120
...
PetRaceGraTable petracegra[27] =
{
	...
	{100852, 100853, 100855, "剋拉爾", "拉斯基", "剋達達", 0, 0, 0, "良好", "良好", "良好"},
	...
	{100883, 100884, 100885, "尤裏蛙", "裘裏蛙", "艾爾蛙", 0, 0, 0, "良好", "良好", "良好"},
	...
	{100913, 100914, 100915, "萊姆洛斯", "硃利洛斯", "辛普洛斯", 0, 0, 0, "良好", "良好", "良好"},
	...
	{100916, 100918, 100919, "立杜魯斯", "巴剋亞司", "雷德力剋斯", 0, 0, 0, "良好", "良好", "良好"},
	...
	{100902, 100903, 100905, "格裏蘭", "摩裏", "塔斯夫", 0, 0, 0, "良好", "良好", "良好"},
	{100912, 100911, 100910, "伊夫霍恩", "布依倫斯", "布萊茲", 0, 0, 0, "良好", "良好", "良好"},
	{100891, 100892, 100893, "嘎吱拉", "哥斯哥斯", "濛哥拉斯", 0, 0, 0, "良好", "良好", "良好"},
};
#else
PetRaceGraTable petracegra[27] =
{
	...
	{100852, 100853, 100855, "剋拉爾", "拉斯基", "剋達達", 0, 0, 0, 2, 2, 2, "良好", "良好", "良好"},
	...
	{100883, 100884, 100885, "尤裏蛙", "裘裏蛙", "艾爾蛙", 0, 0, 0, 2, 2, 2, "良好", "良好", "良好"},
	...
	{100913, 100914, 100915, "萊姆洛斯", "硃利洛斯", "辛普洛斯", 0, 0, 0, 2, 2, 2, "良好", "良好", "良好"},
	...
	{100916, 100918, 100919, "立杜魯斯", "巴剋亞司", "雷德力剋斯", 0, 0, 0, 2, 2, 2, "良好", "良好", "良好"},
	...
	{100902, 100903, 100905, "格裏蘭", "摩裏", "塔斯夫", 0, 0, 0, 2, 2, 2, "良好", "良好", "良好"},
	{100912, 100911, 100910, "伊夫霍恩", "布依倫斯", "布萊茲", 0, 0, 0, 2, 2, 2, "良好", "良好", "良好"},
	{100891, 100892, 100893, "嘎吱拉", "哥斯哥斯", "濛哥拉斯", 0, 0, 0, 2, 2, 2, "良好", "良好", "良好"},
};
#endif
		...
		case NPC_State_WaitDropStake:
			{
				...
				if (t1 >= statechangetime)
				{
					...
					snprintf(tmpbuf, sizeof(tmpbuf), "請大傢停止下注，寵物賽跑開始羅！%s的賠率為%5.2f；%s的賠率為%5.2f；%s的賠率為%5.2f",
		...
		case NPC_State_ShowWinPet:
			{
				...
				if (t1 >= statechangetime)
				{
					...
					snprintf(tmpbuf, sizeof(tmpbuf), "寵物競速準備中，請大傢踴躍下注！");
					CHAR_talkToFloor(floor, meindex, tmpbuf, CHAR_COLORYELLOW);
				}
			}
			break;
