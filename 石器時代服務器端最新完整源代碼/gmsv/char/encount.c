...
typedef struct tagENCOUNT_Table
{
    ...
    int                 zorder;
    int                 groupid[ENCOUNT_GROUPMAXNUM];       /* 弘夥□皿No */
    int                 createprob[ENCOUNT_GROUPMAXNUM];    /* 公及弘夥□皿及請蜇   */
    RECT                rect;
}ENCOUNT_Table;
...

{
    ...
    print( "有效的遇敵坐標數是 %d..", ENCOUNT_encountnum );
