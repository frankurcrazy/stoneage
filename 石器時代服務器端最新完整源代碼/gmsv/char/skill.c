...
int PROFESSION_MAGIC_COST_MP( int charaindex, int skill_num )
{
	...
	if( (strcmp( skill_name, "PROFESSION_SUMMON_THUNDER" )) == 0 ){		// 召雷術
				if( skill_level >= 8 )		dec_mp = 30;
				else if( skill_level >= 5 )	dec_mp = 25;
				else if( skill_level >= 3)	dec_mp = 20;	
				else						dec_mp = 10;
	}else
	if( (strcmp( skill_name, "PROFESSION_CURRENT" )) == 0 ){			// 電流術
	...
	if( (strcmp( skill_name, "PROFESSION_STORM" )) == 0 ){				// 暴風雨
#ifdef _PROFESSION_ADDSKILL
	...
	if( (strcmp( skill_name, "PROFESSION_ICE_ARROW" )) == 0 ){			// 冰箭術
				if( skill_level >= 8)		dec_mp = 20;
				else if( skill_level >= 4 )	dec_mp = 15;
				else						dec_mp = 10;
	}else
	if( (strcmp( skill_name, "PROFESSION_ICE_CRACK" )) == 0 ){			// 冰爆術
#ifdef _PROFESSION_ADDSKILL
                if( skill_level >= 10 )		dec_mp = 80;
	...
	if( (strcmp( skill_name, "PROFESSION_FIRE_SPEAR" )) == 0 ){			// 火龍槍
	...
	if( (strcmp( skill_name, "PROFESSION_BLOOD_WORMS" )) == 0 ){		// 嗜血蠱
				if( skill_level >= 10 )		dec_mp = 15;
				else if( skill_level >= 5 ) dec_mp = 10;
				else						dec_mp = 5;
	}else
	if( (strcmp( skill_name, "PROFESSION_SIGN" )) == 0 ){				// 一針見血

				if( skill_level >= 8 )		dec_mp = 10;
				else						dec_mp = 5;

	}else
	if( (strcmp( skill_name, "PROFESSION_ENCLOSE" )) == 0 ){			// 附身術
				if( skill_level >= 10 )		dec_mp = 80;
				else if( skill_level >= 8 ) dec_mp = 70;
				else if( skill_level >= 5)  dec_mp = 60;
				else						dec_mp = 50;
	}else
	if( (strcmp( skill_name, "PROFESSION_ICE_MIRROR" )) == 0 ){			// 冰鏡術
	...
	if( (strcmp( skill_name, "PROFESSION_FIRE_ENCLOSE" )) == 0 ){		// 火附體		
				if( skill_level >= 10 )		dec_mp = 50;
				else if( skill_level >= 7 )	dec_mp = 40;			
				else if( skill_level >= 4 )	dec_mp = 30;
				else						dec_mp = 20;
	}else	
	if( (strcmp( skill_name, "PROFESSION_ICE_ENCLOSE" )) == 0 ){		// 冰附體		
				if( skill_level >= 10 )		dec_mp = 50;
				else if( skill_level >= 7 )	dec_mp = 40;			
				else if( skill_level >= 4 )	dec_mp = 30;
				else						dec_mp = 20;
	}else
	if( (strcmp( skill_name, "PROFESSION_THUNDER_ENCLOSE" )) == 0 ){	// 雷附體
				if( skill_level >= 10 )		dec_mp = 50;
				else if( skill_level >= 7 )	dec_mp = 40;			
				else if( skill_level >= 4 )	dec_mp = 30;
				else						dec_mp = 20;
	}else	
	if( (strcmp( skill_name, "PROFESSION_TRANSPOSE" )) == 0 ){			// 移形換位		
				if( skill_level >= 10 )		dec_mp = 50;
	...
	if( (strcmp( skill_name, "PROFESSION_CALL_NATURE" )) == 0 ){  // 號召自然
	...
	if( (strcmp( skill_name, "PROFESSION_BOUNDARY" )) == 0 ){  // 四屬性結界
	            char *pszP=NULL; 
		        if( skill_level > 9 )	dec_mp = 20;
				else if( skill_level > 6 )	dec_mp = 15;			
				else dec_mp = 10;
				//破除結界耗損mp與其他結界不同
				if( (pszP = strstr( PROFESSION_SKILL_getChar( Pskillid, PROFESSION_SKILL_OPTION), "破結界" ) ) != NULL ){// 技能的參數
                    if( skill_level >= 9 )	dec_mp = 20;
				    else if( skill_level > 4 )	dec_mp = 15;	
