...
static luaL_Reg Map_RegList[] = {
	...
	{"取地闆裝飾",NPC_Lua_Map_GetTileAndObjId},
	{"置地闆裝飾",NPC_Lua_Map_SetTileAndObjId},
	{"是否走動",NPC_Lua_Map_GetWalkAbleFromPoint},
	{"取數據",NPC_Lua_Map_GetImageData},
	{"置數據",NPC_Lua_Map_SetImageData},
	{"取物件",NPC_Lua_Map_GetTopObj},
	{"取下一個物件",NPC_Lua_Map_GetNextObj},
	{"檢測圖片索引",NPC_Lua_Map_CheckImageIndex},
...
static luaL_Reg Spell_RegList[] = {
	...
	{"PETSKILL_SetData",NPC_Lua_Spell_PETSKILL_SetData},//未測試
	{"PROFESSION_SetData",NPC_Lua_Spell_PROFESSION_SetData},//未測試
	{"MAGIC_SetData",NPC_Lua_Spell_MAGIC_SetData},//未測試
	{"取寵物技能數據",NPC_Lua_Spell_PETSKILL_GetData},
	{"取職業技能數據",NPC_Lua_Spell_PROFESSION_GetData},
	{"取精靈技能數據",NPC_Lua_Spell_MAGIC_GetData},
	{"置寵物技能數據",NPC_Lua_Spell_PETSKILL_SetData},//未測試
	{"置職業技能數據",NPC_Lua_Spell_PROFESSION_SetData},//未測試
	{"置精靈技能數據",NPC_Lua_Spell_MAGIC_SetData},//未測試
#endif	
	{"置精靈技能數據",NPC_Lua_Spell_MAGIC_SetData},//未測試
	//{"置寵物技能數據",NPC_Lua_Spell_PETSKILL_SetData},//未測試
	{"取寵物技能數據",NPC_Lua_Spell_PETSKILL_GetData},
...
//NL
		...
		{"置簽到數據", NPC_Lua_NL_SetCharSignDay},
		{"GetCharSignDay", NPC_Lua_NL_GetCharSignDay},
		{"取簽到數據", NPC_Lua_NL_GetCharSignDay},
		{"writeshopdata", NPC_Lua_NL_WriteShopData},
		{"寫商城數據", NPC_Lua_NL_WriteShopData},
		...
		{"GetConfigLineVal", NPC_Lua_NL_GetConfigLineVal},//返迴CF字段值
		{"CheckNpcEventFree", NPC_Lua_CheckNpcEventFree},//使用NPC腳本檢測條件
		{"DoNpcEventAction", NPC_Lua_DoNpcEventAction},//使用NPC腳本語言
		{"SetTimer", NPC_Lua_NL_SetTimer},//設定一個定時器返迴定時器ID
		{"DelTimer", NPC_Lua_NL_DelTimer},//刪除一個定時器ID
		{"RunSaFuncII", NPC_Lua_NL_RunSaFuncII},//調用一個服務端內定義好的2個INT參數的函數。
		{"RunSaFuncIII", NPC_Lua_NL_RunSaFuncIII},//調用一個服務端內定義好的3個INT參數的函數。
		{"ANSI_PlayerLoop", NPC_Lua_NL_ANSI_PlayerLoop},//遍曆下一個人物索引
		{"ANSI_PetLoop", NPC_Lua_NL_ANSI_PetLoop},//遍曆下一個寵物索引
		{"ANSI_ItemLoop", NPC_Lua_NL_ANSI_ItemLoop},//遍曆下一個道具索引
		...
		{"取服務器名", NPC_Lua_NL_getGameservername},
		...
		{"取cf類型", NPC_Lua_NL_GetConfigLineType},//返迴CF字段類型
		{"取CF值", NPC_Lua_NL_GetConfigLineVal},//返迴CF字段值
		{"取cf值", NPC_Lua_NL_GetConfigLineVal},//返迴CF字段值
		{"npc語句檢測", NPC_Lua_CheckNpcEventFree},//使用NPC腳本檢測條件
		{"NPC語句檢測", NPC_Lua_CheckNpcEventFree},//使用NPC腳本檢測條件
		{"使用NPC腳本", NPC_Lua_DoNpcEventAction},//使用NPC腳本語言
		{"創建定時器", NPC_Lua_NL_SetTimer},//設定一個定時器返迴定時器ID
		...
		{"封包總數", NPC_Lua_NL_AddCheckNum},
		{"製作字符串封包", NPC_Lua_NL_Mkstring},
		{"製作整數封包", NPC_Lua_NL_Mkint},
		{"發送封包", NPC_Lua_NL_SendMesg},
		{NULL, NULL},
};
...
//	{"CharRidNo", NPC_Lua_Char_CharRidNo},  //騎寵未同步，暫時關閉
...
//	{"RandMsg", NPC_Lua_Char_RandMsg},
  {"GetBeatitudeNum", NPC_Lua_Char_GetBeatitudeNum},
	...
	{"復製人物數據", copyChar},
//取數據的接口
	{"是否完成任務", NPC_Lua_Char_IsEventEnd},
	{"是否進行任務", NPC_Lua_Char_IsEventNow},
	{"取金幣數", NPC_Lua_Char_GetVipPoint},
	{"置金幣數", NPC_Lua_Char_SetVipPoint},
	{"取積分點數", NPC_Lua_Char_GetAmPoint},
	{"置積分點數", NPC_Lua_Char_SetAmPoint},
	{"取彩幣點數", NPC_Lua_Char_GetRmbPoint},
	{"置彩幣點數", NPC_Lua_Char_SetRmbPoint},
	{"尋找道具ID", NPC_Lua_Char_FindItemId},
	{"尋找道具id", NPC_Lua_Char_FindItemId},
	{"尋找寵物ID", NPC_Lua_Char_FindPetEnemyId},
	{"尋找寵物id", NPC_Lua_Char_FindPetEnemyId},

	{"取數據", NPC_Lua_Char_GetData},
	{"取道具ID", NPC_Lua_Char_GetItemId},
	{"取道具id", NPC_Lua_Char_GetItemId},
	{"取寵物ID", NPC_Lua_Char_GetPetEnemyId},
	{"取寵物id", NPC_Lua_Char_GetPetEnemyId},
	{"取道具索引", NPC_Lua_Char_GetItemIndex},
	{"取寵物索引", NPC_Lua_Char_GetPetIndex},
	{"取團隊索引", NPC_Lua_Char_GetTeamIndex},

//置數據的接口
	{"取消完成任務", NPC_Lua_Char_ClrEvtEnd},
	{"取消進行任務", NPC_Lua_Char_ClrEvtNow},
	{"完成任務", NPC_Lua_Char_SetEvtEnd},
	{"進行任務", NPC_Lua_Char_SetEvtNow},
	{"置數據", NPC_Lua_Char_SetData},

//事件置的接口
	{"注冊移動時迴調", NPC_Lua_Char_SetWalkPreEvent},
	{"注冊移動後迴調", NPC_Lua_Char_SetWalkPostEvent},
	{"注冊踩踏時迴調", NPC_Lua_Char_SetPreOverEvent},
	{"注冊踩踏後迴調", NPC_Lua_Char_SetPostOverEvent},
	{"注冊動作時迴調", NPC_Lua_Char_SetWatchEvent},
	{"注冊循環迴調", NPC_Lua_Char_SetLoopEvent},
	{"注冊對話迴調", NPC_Lua_Char_SetTalkedEvent},
	{"SetOFFEvent", NPC_Lua_Char_SetOFFEvent},
	{"注冊方嚮迴調", NPC_Lua_Char_SetLookedEvent},
	{"注冊道具丟棄踩踏迴調", NPC_Lua_Char_SetItemPutEvent},
	{"注冊對話框迴調", NPC_Lua_Char_SetWindowTalkedEvent},
#ifdef _USER_CHARLOOPS
	{"注冊原地迴調", NPC_Lua_Char_SetCharLoopsEvent},
	{"注冊戰鬥迴調", NPC_Lua_Char_SetBattleProPertyEvent},
#endif
//金幣接口
	{"取金幣", NPC_Lua_Char_VipPoint},
	{"全體恢復", NPC_Lua_Char_HealAll},
	{"取寵物技能ID", NPC_Lua_Char_GetPetSkillId},
	{"取寵物技能id", NPC_Lua_Char_GetPetSkillId},
	{"取寵物技能名", NPC_Lua_Char_GetPetSkillName},
	{"取寵物技能說明", NPC_Lua_Char_GetPetSkillMsg},
	{"置寵物技能ID", NPC_Lua_Char_SetPetSkill},
	{"置寵物技能id", NPC_Lua_Char_SetPetSkill},
	{"檢測玩傢索引",NPC_Lua_CHAR_CHECKINDEX},
	...
	{"取道具說名", NPC_Lua_Char_ITEMID_NAME2},
	{"取道具等級", NPC_Lua_Char_ITEMID_LEVEL},
	{"取道具價格", NPC_Lua_Char_ITEMID_GOLD},
	{"取道具圖片", NPC_Lua_Char_ITEMID_RANO},
	{"尋寵物索引", NPC_Lua_Char_FindPetIndex},
	{"檢測騎證", NPC_Lua_Char_CharRidNo},
	{"取寵物主人索引", NPC_Lua_Char_GetPetOwner},
	{"取寵物數據來自原型",NPC_Lua_Char_GetDataFromEnemyBase},
	{"取寵物ID來自調用", NPC_Lua_Char_GetEnemyBaseIdFromEnemyId},
	{"取寵物調用ID來自原型", NPC_Lua_Char_GetEnemyIdFromEnemyBaseId},
	{"取寵物id來自調用", NPC_Lua_Char_GetEnemyBaseIdFromEnemyId},
	{"取寵物調用id來自原型", NPC_Lua_Char_GetEnemyIdFromEnemyBaseId},
	{"取IP", NPC_Lua_Char_GetIp},
	{"取ip", NPC_Lua_Char_GetIp},
	{"取寵物四圍",NPC_Lua_Char_GetAllocPoint},
	{"置寵物四圍", NPC_Lua_Char_SetAllocPoint},
	{"取寵物最大索引", NPC_Lua_Char_GetMaxPetIndex},
	{"取人物最大索引", NPC_Lua_Char_GetMaxPlayerIndex},
	{"保存寵物描述", NPC_Lua_Char_SavePetToString},
	{"加載寵物描述", NPC_Lua_Char_LoadPetFromString},
	{"計算數據", NPC_Lua_Char_ComplianceParameter},
	{"取人物索引來自帳號密碼", NPC_Lua_Char_GetPlayerFromAccAndName},
	{"取道具數量", NPC_Lua_Char_GetPlayerItemNum},
	{"取寵物數量", NPC_Lua_Char_GetPlayerPetNum},
	{"取道具空數量", NPC_Lua_Char_GetEmptyItemBoxNum},
	{"取寵物空數量", NPC_Lua_Char_GetEmptyPetBoxNum},
	{"檢測寵物索引", NPC_Lua_Char_CheckPet},
	{"檢測人物索引", NPC_Lua_Char_CheckPlayer},
...
//	{"取虛擬人物最大數", getOnlinePlayer_},
	...
	{"取寵物技能ID", NPC_Lua_Char_GetPetSkillNo},
	{"置寵物技能ID", NPC_Lua_Char_SetPetSkillNo},
	{"取寵物技能id", NPC_Lua_Char_GetPetSkillNo},
	{"置寵物技能id", NPC_Lua_Char_SetPetSkillNo},
	{"getFd", NPC_Lua_Char_GetfdFromCharaIndex},
	{"取發包ID", NPC_Lua_Char_GetfdFromCharaIndex},
...
#endif
	//取數據的接口
		{"取數據", NPC_Lua_Item_GetData},

	//置數據的接口
		{"置數據", NPC_Lua_Item_SetData},
		{"取模闆數據", NPC_Lua_Item_GetDataFromItemSet},
		{"取過期時間", NPC_Lua_Item_GetValidity},
		{"取主人索引", NPC_Lua_Item_GetItemOwner},
		{"最大索引", NPC_Lua_Item_GetMaxItemIndex},
		{"保存道具描述", NPC_Lua_Item_SaveItemToString},
		{"置過期時間", NPC_Lua_Item_SetValidity},
		{"加載道具描述", NPC_Lua_Item_LoadItemFromString},
...
//事件設置的接口
	...
	{"取x", NPC_Lua_Obj_GetX},
	{"取y", NPC_Lua_Obj_GetY},
	{"取地圖", NPC_Lua_Obj_GetFloor},
	{"置類型", NPC_Lua_Obj_SetType},
	{"置形像", NPC_Lua_Obj_SetCharType},
	{"置X", NPC_Lua_Obj_SetX},
	{"置Y", NPC_Lua_Obj_SetY},
	{"置x", NPC_Lua_Obj_SetX},
	{"置y", NPC_Lua_Obj_SetY},
	{"置地圖", NPC_Lua_Obj_SetFloor},
...
//事件設置的接口
	...
	{"普通攻擊", Attack},
	{"加血", Recovery},
	{"取玩傢索引", NPC_Lua_Battle_GetPlayIndex},
	{"置方嚮", NPC_Lua_Battle_SetNORisk},
	{"置戰鬥標誌", NPC_Lua_Battle_SetMod},
	{"置類型", NPC_Lua_Battle_SetType},
	{"注冊戰鬥時迴調", NPC_Lua_Battle_SetWinEvent},
	{"取數據", NPC_Lua_Battle_GetData},
	{"置數據", NPC_Lua_Battle_SetData},
	{"取位置", NPC_Lua_Battle_IndexToNo},
	{"取索引", NPC_Lua_Battle_NoToIndex},
	{"檢測索引", NPC_Lua_Battle_CheckIndex},
	{"結束", NPC_Lua_Battle_Exit},
	{"注冊戰鬥後迴調", NPC_Lua_Battle_SetEndEvent},
...
static luaL_Reg SQL_RegList[] = {
	...
	{"執行", NPC_Lua_SQL_Push},
	{"注冊執行迴調", NPC_Lua_SQL_PushPop},
	{"注冊執行迴調I", NPC_Lua_SQL_PushPopAdv},
	{"注冊執行迴調II", NPC_Lua_SQL_QueryFirstRow},
	{"取下一條結果", NPC_Lua_SQL_FetchRow},
	{"釋放結果集", NPC_Lua_SQL_FreeResult},
...
//	{"GetPetTransRange", NPC_Lua_NLG_GetPetTransRange},
	...
	{"創建戰鬥AB", NPC_Lua_NLG_CreateVsEnemyAB},
	{"創建人物戰鬥", NPC_Lua_NLG_CreateBattlePvP},
	{"隨機觀戰", NPC_Lua_NLG_SearchWatchBattleRandIndex},

	{"刪除寵物", NPC_Lua_NLG_DelPet},
	{"刪除寵物位置", NPC_Lua_NLG_DelHaveIndexPet},
	{"刪除道具", NPC_Lua_NLG_DelItem},
	{"解散隊伍", NPC_Lua_NLG_DischargeParty},

	{"給寵物", NPC_Lua_NLG_GivePet},
	...
	{"說話", NPC_Lua_NLG_TalkToCli},
	{"地圖說話", NPC_Lua_NLG_TalkToFloor},

	{"更新人物", NPC_Lua_NLG_UpChar},
	{"更新人物I", NPC_Lua_NLG_UpStateBySecond},
	{"更新人物II", NPC_Lua_NLG_UpStateByThird},
	{"嚮玩傢更新數據", NPC_Lua_NLG_Update_Party},

	{"傳送", NPC_Lua_NLG_Warp},
	{"移動", NPC_Lua_NLG_WalkMove},
	{"觀戰", NPC_Lua_NLG_WatchEntry},

	{"最大人數I", NPC_Lua_NLG_GetMaxPlayNum},
	{"檢測人物索引", NPC_Lua_NLG_CheckPlayIndex},

	{"保存數據", NPC_Lua_NLG_Save},
	{"尋找寵物", NPC_Lua_NLG_FindPet},
	{"取地圖", NPC_Lua_NLG_GetMap},
	{"寵物更新", NPC_Lua_NLG_PetUp},
	//{"添加職業技能", NPC_Lua_NLG_AddSk},
	//{"置職業技能", NPC_Lua_NLG_SetZy},
	{"GetXY", NPC_Lua_NLG_GetXY},
	{"滾動公告", dengon},
#ifdef _GUANGHUAN
	{"更新光環",NPC_Lua_NLG_UpHalo},
#endif
	{"檢測前方障礙", NPC_Lua_NLG_WalkJc},
	{"T玩傢", NPC_Lua_NLG_KickPlayer},
	{"恢復", NPC_Lua_NLG_HealOne},
	{"全體恢復", NPC_Lua_NLG_HealAll},
	{"提升等級", NPC_Lua_NLG_LevelUpTo},
	{"增加經驗", NPC_Lua_NLG_AddExp},
	{"更新道具", NPC_Lua_NLG_UpItem},
	{"更新寵物", NPC_Lua_NLG_UpPet},
	{"刪除寵物位置", NPC_Lua_NLG_DelPetByPos},
	{"刪除寵物索引", NPC_Lua_NLG_DelPetByIndex},
	{"刪除道具位置", NPC_Lua_NLG_DelItemByPos},
	{"刪除道具索引", NPC_Lua_NLG_DelItemByIndex},
	{"製寵物", NPC_Lua_NLG_GivePetOne},
	{"取寵物來自索引", NPC_Lua_NLG_GivePetByIndex},
	{"給道具索引", NPC_Lua_NLG_GiveItemOne},
	{"取道具來自索引", NPC_Lua_NLG_GiveItemByIndex},
	{"傳送I", NPC_Lua_NLG_WarpToSpecificPoint},
	{"更新點數", NPC_Lua_NLG_UpSkillupPoint},
	{"原地", NPC_Lua_NLG_StayEncount},
	{"全球說話", talkToAllServer },
...
/*
	...
	if( PKLIST_CheckPKReapetTeam(
		...
		CHAR_talkToCli( charaindex0, -1, "重復戰鬥。", CHAR_COLORYELLOW );
		CHAR_talkToCli( charaindex1, -1, "重復戰鬥。", CHAR_COLORYELLOW );
		return BATTLE_ERR_ALREADYBATTLE;
	}
*/	
#endif
...
void NPC_Lua_SQLPushAdvCallBack(int luaresult,int luaflg,int luaerrno,char* luaerrstr,int luafieldCount,int rowCount,int rowAt,char* row,char* filepath,char* function,int npcindex,int charaindex,char* msg)
{
	...
	if(lua_type(M_Script_Lua, -1) != LUA_TFUNCTION)
	{
		print("無法執行指定函數 NPC_Lua_SQLPushAdvCallBack\n");
		return ;
	}
