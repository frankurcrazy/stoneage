...
/*
 * 夫弘奶件仄化中卅中｝ 夫弘奶件仄化中月｝ 夫弘奶件   平乓仿綜曰
 * 夫弘失它玄  ( 本□皮   ) , 夫弘失它玄  ( 失件夫永弁   )
 *  N 反 NOT ｝ W 反 WHILE , UL 反 UNLOCK 及儀
 */
typedef enum
{
	NULLCONNECT,
    ...
    WHILECANNOTLOGIN,   /*  夫弘奶件匹五卅井勻凶凜及失件夫永弁質        */
    WHILECHARDELETE,    /*  平乓仿綽輪      */
    ...
    WHILESAVEWAIT,              /* 夫弘失它玄及本□皮卞墊仁蟆及賜  謹切  */
}LoginType;
...
#define CDKEYLEN    16
#define PASSWDLEN   33
/* 仇木及  凳反尕第(允月卅日 Char 及STRING64 手贋濠卅襖卞濠曰晶月仇午*/
#define CHARNAMELEN     32

#define CLITIMEOUT_SEC  120     /* 弁仿奶失件玄井日read仄卅井勻凶日｝
                                   仇及凜棉匹正奶丞失它玄｝夫弘失它玄［ */

#define		NET_STRING_SUCCESSFULL	"successful"
#define		NET_STRING_FAILED		"failed"

// 孔勾丹及    及伉□玉］仿奶玄田永白央扔奶術
