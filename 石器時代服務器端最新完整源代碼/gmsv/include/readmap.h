...
/* 以下  ＬＳ２  使        ＳＡ    使      (? X      ? @) */
    ...
    MAP_INTODARKNESS,       /*  入    時  暗      */
    MAP_INTOCONFUSION,      /*  入    時  混?    */

    MAP_OUTOFPOISON,         /*  入    時  毒    */
    MAP_OUTOFPARALYSIS,      /*  入    時            */
    MAP_OUTOFSILENCE,        /*  入    時  瀋?  */
    MAP_OUTOFSTONE,          /*  入    時  石    */
    MAP_OUTOFDARKNESS,       /*  入    時  暗      */
    MAP_OUTOFCONFUSION,      /*  入    時  混?    */
