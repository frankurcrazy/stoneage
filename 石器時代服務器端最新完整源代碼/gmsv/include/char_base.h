...
{
      CHAR_TRADE_FREE,      /* 可交易 */
      CHAR_TRADE_SENDING,   /* 交易請求中 */
      CHAR_TRADE_TRADING,   /* 交易中 */
      CHAR_TRADE_LOCK,	    /* 交易鎖定中 */
}CHAR_TRADE_MODE;
...
typedef enum
{
	...
	ROULETTE51 = 101, ROULETTE52, ROULETTE53,	//橫列
...
#ifdef _NPC_DEPOTPET // 開放寵物倉庫同時增加道具倉庫容量
...
#ifdef _ADD_POOL_ITEM				// (不可開) WON ADD 增加可寄放的道具
#define CHAR_MAXPOOLITEMHAVE	30
#else
...
#ifdef _NEW_ITEM_
#define CHAR_MAXITEMHAVE (CHAR_STARTITEMARRAY+CHAR_MAXITEMNUM*3)
#else
...
typedef enum
{
  ...
  CHAR_LEARNRIDE,
    ...
    CHAR_LIMITLEVEL,
#ifdef _PET_FUSION
	CHAR_FUSIONCODE,		//物種編碼
	CHAR_FUSIONINDEX,		//孵化寵物編號
	CHAR_FUSIONRAISE,		//  養次數
	CHAR_FUSIONBEIT,		//寵蛋旗標
    ...
    CHAR_SAVEINDEXNUMBER,	/*  SaveFile .0.char or .1.char */
...
#ifdef _ATTACK_MAGIC
		CHAR_EARTH_EXP,						// 玩傢的地魔法熟練度
		CHAR_WATER_EXP,						// 玩傢的水魔法熟練度
		CHAR_FIRE_EXP,						// 玩傢的火魔法熟練度
		CHAR_WIND_EXP,						// 玩傢的風魔法熟練度
		CHAR_EARTH_RESIST,					// 玩傢的地魔法抗性
		CHAR_WATER_RESIST,					// 玩傢的水魔法抗性
		CHAR_FIRE_RESIST,					// 玩傢的火魔法抗性
		CHAR_WIND_RESIST,					// 玩傢的風魔法抗性
		CHAR_EARTH_ATTMAGIC_EXP,			// 玩傢的地魔法熟練度經驗值
		CHAR_WATER_ATTMAGIC_EXP,			// 玩傢的水魔法熟練度經驗值
		CHAR_FIRE_ATTMAGIC_EXP,				// 玩傢的火魔法熟練度經驗值
		CHAR_WIND_ATTMAGIC_EXP,				// 玩傢的風魔法熟練度經驗值
	 	CHAR_EARTH_DEFMAGIC_EXP,			// 玩傢的地魔法抗性經驗值
		CHAR_WATER_DEFMAGIC_EXP,			// 玩傢的水魔法抗性經驗值
		CHAR_FIRE_DEFMAGIC_EXP,				// 玩傢的火魔法抗性經驗值
		CHAR_WIND_DEFMAGIC_EXP,				// 玩傢的風魔法抗性經驗值
#endif


#ifdef _GAMBLE_BANK
		CHAR_PERSONAGOLD,	//賭場個人銀行
#endif
#ifdef _DROPSTAKENEW
		CHAR_GAMBLENUM,		//賭場積分
#endif
		...
		PROFESSION_CLASS,			// 職業彆
		PROFESSION_LEVEL,			// 職業等級
//		PROFESSION_EXP,				// 職業經驗值
		PROFESSION_SKILL_POINT,		// 技能點數
		ATTACHPILE,					// 增加堆疊
		PROFESSION_FIRE_P,			// 火熟練度
		PROFESSION_ICE_P,			// 冰熟練度
		PROFESSION_THUNDER_P,		// 雷熟練度
		...
		CHAR_BECOMEPIG,
		CHAR_BECOMEPIG_BBI,//要變成的圖號
#endif
		CHAR_LASTLEAVETIME, // Robin add 最後離綫時間
...
#ifdef _ANGEL_SUMMON
		CHAR_HEROCNT, // 完成勇者任務的次數
#endif

#ifdef _TEACHER_SYSTEM
	CHAR_TEACHER_FAME,	// 導師領導聲望
#endif

#ifdef _GM_ITEM
	CHAR_GMTIME,       // 玩傢GM命令次數
#endif
...
typedef enum {
  CHAR_MODAI    			= CHAR_CHARM,    		/*  矢永玄  及及鏑擦艘膜懇襖    */
	CHAR_VARIABLEAI 		= CHAR_LUCK,			/*  矢永玄及鏑擦艘  祭襖  ㄠㄟㄟ  仄凶襖匹  勻化雲仁   */
  CHAR_SLOT 				= CHAR_DEFAULTPET,		/* 檗  毛本永玄請  月旦夫永玄醒  矢永玄互銀迕  */
  CHAR_PETGETLV			= CHAR_CHATVOLUME,		/* 必永玄今木凶伊矛夥  矢永玄及心銀迕   */
  CHAR_PUTPETTIME			= CHAR_LOGINCOUNT,		/*  矢永玄互嘩  卞  井木凶凜棉 */
	CHAR_MAILMODE 			= CHAR_RADARSTRENGTH,	/*   矢永玄及心銀迕  丟□夥霜耨橇謫 */
  CHAR_ALLOCPOINT			= CHAR_LEVELUPPOINT,	/* 伊矛夥失永皿凜及喃曰蕊曰禾奶件玄(矢永玄迕) */
  CHAR_PETMAILBUFINDEX	= CHAR_GETPETCOUNT, 	/* 矢永玄丟□夥(offmsg)尺及index */
	CHAR_PETMAILIDLETIME	= CHAR_SENDMAILCOUNT,	/* 矢永玄丟□夥及啃及凜棉卅升 */
	CHAR_PETMAILFROMFLOOR	= CHAR_DUELBATTLECOUNT,	/* 丟□夥毛霜勻凶凜及白夫失 */
	CHAR_PETMAILFROMX		= CHAR_DUELWINCOUNT,	/* 丟□夥毛霜勻凶凜及  甄   */
	CHAR_PETMAILFROMY		= CHAR_DUELLOSECOUNT,	/* 丟□夥毛霜勻凶凜及  甄   */
	CHAR_PETMAILEFFECT		= CHAR_DUELSTWINCOUNT,	/* 矢永玄丟□夥及請蜇及巨白尼弁玄  寞 */
...
#define CHAR_FS_DUEL    	(1 << 1)
#define CHAR_FS_PARTYCHAT	(1 << 2)	//隊伍頻道開關
#define CHAR_FS_TRADECARD	(1 << 3)
...
#endif
#define	CHAR_FS_SAVE			(1 << 8)	//對話儲存開關
#define CHAR_FS_CHAT			(1 << 9)	//聊天室開關
#ifdef _THE_WORLD_SEND
#define CHAR_FS_WORLD			(1 << 10)	//世界頻道開關
#endif

#ifdef _ONLINE_TALK_IP
#define CHAR_FS_TALKIP			(1 << 12)	//舉報頻道開關
#endif
#define CHAR_FS_AI			(1 << 12)
#endif
typedef enum
{
    CHAR_WORKBATTLEMODE,
	...
	CHAR_WORKFIXEARTHAT_BOUNDARY, //地結界  左16位元存放加強百分比 右16位元存放迴閤數
    ...
    CHAR_WORKLOOPSTARTSECAB,
    CHAR_WORKLOOPSTARTMSECAB,
...
#endif
#ifdef _EQUIT_RESIST
	CHAR_WORKEQUITFIRE,   //裝備抗火
	CHAR_WORKEQUITTHUNDER,//裝備抗雷
	CHAR_WORKEQUITICE,//裝備抗冰
	CHAR_WORKEQUITWEAKEN,//裝備抗虛弱
	CHAR_WORKEQUITBARRIER,//裝備抗魔障
	CHAR_WORKEQUITNOCAST,//裝備抗沉默
	CHAR_WORKEQUITFALLRIDE,//裝備抗落馬
#endif
    ...
    CHAR_WORKRESIST, //異常抗性率
	CHAR_WORKCOUNTER,//反擊率
	CHAR_WORKMPOWER, //加強法師的魔法( 受影響的法術:火山泉 火星球 召雷術 電流術 暴風雨 冰箭術 冰爆術 世界末日 火龍槍 嗜血成性 嗜血蠱 一針見血 附身術 )
#endif
	...
	CHAR_WORKDUCKPOWER,//套裝迴避
    CHAR_WORKRENOCAST, //沉默抗性率
	CHAR_WORKSUITSTR_P,//攻提升 單位為%
	CHAR_WORKSUITTGH_P,//防提升 單位為%
	CHAR_WORKSUITDEX_P,//敏提升 單位為%
#endif
#ifdef _SUIT_ADDPART4
	CHAR_SUITPOISON,   //裝備帶毒
	CHAR_WORKMPOWER2,  //與CHAR_WORKMPOWER相同
	CHAR_WORKUNMPOWER, //抵抗法師的魔法( 受影響的法術:火山泉 火星球 召雷術 電流術 暴風雨 冰箭術 冰爆術 世界末日 火龍槍 嗜血成性 嗜血蠱 一針見血 附身術 )
#endif
#endif//_SUIT_ITEM

#ifdef _IMPRECATE_ITEM
	CHAR_WORKHURTMP,		//傷害 MP
...
#endif
#ifdef _MO_PLAYER_EFFECT
	CHAR_PLAYER_EFFECT_PRIORITY,
	CHAR_PLAYER_EFFECT_PET,
	CHAR_PLAYER_EFFECT_ITEM,
#endif
#ifdef FAMILY_MANOR_
...
#ifdef _PROFESSION_SKILL			// WON ADD 人物職業技能
	CHAR_ENCOUNT_FIX,		// 遇敵率
	CHAR_ENCOUNT_NUM,
	CHAR_WORK_F_PROFICIENCY,// 火熟練度
	CHAR_WORK_I_PROFICIENCY,// 冰熟練度
	CHAR_WORK_T_PROFICIENCY,// 電熟練度
	CHAR_WORK_F_RESIST,		// 火抗
	CHAR_WORK_I_RESIST,		// 冰抗
	CHAR_WORK_T_RESIST,		// 電抗
	CHAR_MYSKILLHIT,		// 命中率
	CHAR_MYSKILLHIT_NUM,		
	CHAR_WORKDIZZY,			// 暈眩
	CHAR_WORKMODDIZZY,
	CHAR_WORKENTWINE,		// 樹根纏繞
	CHAR_WORKMODENTWINE,
	CHAR_WORKTRAP,			// 陷阱
	CHAR_WORKMODTRAP,
	CHAR_WORKDRAGNET,		// 天羅地網
	CHAR_WORKMODDRAGNET,
#ifdef _PROFESSION_ADDSKILL
	//***********注意:這裏的位置不可更動*************
	CHAR_WORKICECRACK,		// 冰爆術
	CHAR_WORKICECRACK2,		// 冰爆術存放處2
	CHAR_WORKICECRACK3,		// 冰爆術存放處3
	CHAR_WORKICECRACK4,		// 冰爆術存放處4
	CHAR_WORKICECRACK5,		// 冰爆術存放處5
	CHAR_WORKICECRACK6,		// 冰爆術存放處6
	CHAR_WORKICECRACK7,		// 冰爆術存放處7
	CHAR_WORKICECRACK8,		// 冰爆術存放處8
	CHAR_WORKICECRACK9,		// 冰爆術存放處9
	CHAR_WORKICECRACK10,	// 冰爆術存放處10
	...
	CHAR_WORK_P_DUCK,		// 迴避
	CHAR_WORKMOD_P_DUCK,
	CHAR_WORK_WEAPON,		// 武器專精
	CHAR_WORKMOD_WEAPON,
	CHAR_WORK_FOCUS,		// 專注戰鬥
	CHAR_WORKMOD_FOCUS,		
	CHAR_WORKINSTIGATE,		// 挑撥
	CHAR_WORKMODINSTIGATE,
	CHAR_WORK_F_ENCLOSE,	// 火附體
	CHAR_WORK_I_ENCLOSE,	// 冰附體
	CHAR_WORK_T_ENCLOSE,	// 雷附體
	...
	CHAR_WORK_array,
#endif
	CHAR_WORKMODRESIST_F,   // 提升火抗性百分比數值
	CHAR_WORKMODRESIST_I,   // 提升冰抗性百分比數值
	CHAR_WORKMODRESIST_T,   // 提升雷抗性百分比數值
#endif

#ifdef _MAGICSTAUTS_RESIST
	CHAR_MAGICFIRE, //火抗精靈
	CHAR_MAGICTHUNDER,//電抗精靈
	CHAR_MAGICICE,//冰抗精靈
#endif
	...
	CHAR_WORKCHATROOMNUM , 
     ...
     CHAR_WORKFOXROUND,  //計算狐狸變身迴閤數
#endif

	CHAR_WORKSTANDBYPET, // Robin add 待機寵
#ifdef _STREET_VENDOR
	CHAR_WORKSTREETVENDOR, // 擺攤狀態 -1:沒在擺攤,也沒在擺攤交易;1:擺攤中;2:賣方在交易中;3:擺攤的買方
	CHAR_WORKSTREETVENDOR_WHO, // 誰和我交易
#endif
...
#endif
#ifdef _MAP_TIME
	CHAR_WORK_MAP_TIME,	// 特殊地圖倒數
#endif
#ifdef _PETSKILL_LER
	CHAR_WORK_RELIFE,		// 雷爾復活
#endif
#ifdef _TEACHER_SYSTEM
	CHAR_WORK_GET_TEACHER_FAME,	// 導師領導聲望
#endif

	CHAR_WORKSKYWALKER, // GM天行者??

	CHAR_WORKLASTMERGETIME, // 最後閤成時間
...
#endif
	CHAR_WORK_TEMP_FLOOR,					// 屢ヒ□ダ肱□弦
	CHAR_WORK_TEMP_X_Y,						// 屢ヒ□XY□斜 (葵□じw X □斜, □□じw Y □斜)

	CHAR_WORKDEBUGMODE, // 除錯模式中

	CHAR_WORKITEMINDEX, // 物品序號
	
	CHAR_WORKTOITEMINDEX, // 物品序號

#ifdef _NEW_STREET_VENDOR
	CHAR_WORKSTREETVENDORTYPE, // 擺攤類型
#endif
	
#ifdef _TALK_CHECK
	CHAR_WORK_TALKCHECK,  // 說話驗證
#endif
	...
	CHAR_WORKWORLDSENDTIME,
		...
		CHAR_WORK_LISTPAGE,
#ifdef _AUTO_PK
		CHAR_WORK_AUTOPK,       			// 自動化PK
		CHAR_WORK_AUTOPK_DEAD,				// 死亡記
#endif
  ...
  CHAR_WORKPASSIVE_DUCK,				//閃避
  CHAR_WORKPASSIVE_ACURATE,		//命中
  CHAR_WORKPASSIVE_CRITICAL,		//暴擊
  CHAR_WORKPASSIVE_COUNTER,		//反擊
  CHAR_WORKPASSIVE_MULTIPLE,		//倍數
#endif
#ifdef _JZ_NEWSCRIPT_LUA
...
#define			CHAR_P_STRING_CHARSINGMODE	( 1 << 31 )		// 0x80000000
