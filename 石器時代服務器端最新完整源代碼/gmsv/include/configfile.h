...
int getAutoGetSkill(void);//是否開放天生獲得被動技能
int getSkillFusion(void);//被動技能是否可以遺傳
int getSkillCount(void);//被動技能數量
int getSkillPos(void);		//被動技能習得位置
int getRandSkill(void);	//隨機獲得技能
