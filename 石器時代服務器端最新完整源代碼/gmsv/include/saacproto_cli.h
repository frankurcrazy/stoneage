...
#if _ATTESTAION_ID == 1
void saacproto_ACServerLogin_send( int fd, int id, char* servername,char* serverpas ) ; /* ../../doc/saacproto.html line 90 */
#else
...
#else
void saacproto_ACCharList_send( int fd,char* id,char* pas,char* ip,char* mac,int mesgid,int charlistflg ) ; /* ../../doc/saacproto.html line 123 */
#endif
...
void saacproto_ACServerKey_recv( int acfd, int key);
