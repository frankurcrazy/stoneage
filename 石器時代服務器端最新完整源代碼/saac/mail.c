...
#define MAX_FLUSH_MAIL 1024
    ...
    /*   端卞霜耨允月 */
    for(i=0;i< flush_i; i++ ){
        /* flush 及樺寜反｝flush毛霜耨仄化五凶必□丞扔□田□卞
           覆仄化分仃霜耨允木壬中中 */
