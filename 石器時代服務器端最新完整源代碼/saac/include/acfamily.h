...
#ifdef _FIX_10_FMPOINT		// WON ADD 九大莊園
...
#define FAMILY_MEMONUM          35              // 傢族留言闆最大留言數量
#define FAMILY_MEMOLEN          256
#define FMSMEMOINDEX            10000           // 傢族之間留言闆 index
#define FMSMEMONUM              140
#define TOPFMLISTNUM            10              // 傢族排行榜數量
...
#define MINAPPLYPNUM            10              // 申請傢族最低人數
#define FMMEMBERINDEX           "fmmember"
#define FMMEMOLIST              "memo"
#define FMELDERNUM		5		// 長老數量
#define FMMAXGOLD			1000000000	// 傢族基金上限

// shan 20011207
#define MAXRECVPOP				5000000	// 傢族聲望轉移上限
// CoolFish: 2001/11/26
//#define MAXRECVPOP			2500000		// 傢族聲望轉移上限
